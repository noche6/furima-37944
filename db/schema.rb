...
ActiveRecord::Schema.define(version: 2022_05_27_071520) do
  ...
  create_table "purchase_records", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["items_id"], name: "index_purchase_records_on_items_id"
  ...
  add_foreign_key "purchase_records", "items", column: "items_id"
